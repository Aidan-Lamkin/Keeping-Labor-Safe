...
/* DEPRECATED */
/* Don't want to obscure any scenarios where the final sample date is not the end of the actual delivery */
...
CREATE PROCEDURE [dep].[uspStoreKlsCasePostProcessDataflow]
AS
BEGIN
